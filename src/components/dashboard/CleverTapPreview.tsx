...
export default function CleverTapPreview() {
  ...
  return (
    <Card className="glass-panel group relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:border-primary/50 cursor-pointer">
      <Link href="/dashboard/clevertap-tracker" className="absolute inset-0 z-20" aria-label="Launch CleverTap Intelligence" />
      ...
      <CardHeader className="pb-2 relative z-10">
        <CardTitle className="flex items-center gap-3 text-base group-hover:text-primary transition-colors">
          ...
          CleverTap Intelligence
        </CardTitle>
        <CardDescription className="text-xs text-muted-foreground">
          Advanced event telemetry & reporting wizard.
        </CardDescription>
      </CardHeader>
